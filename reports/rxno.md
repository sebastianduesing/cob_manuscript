...
| ----- | ----- | ----- | ----- |
| All classes (including imports) | 985 | 757 | 76.85% |
| Classes in RXNO namespace | 653 | 650 | 99.54% |

RXNO has 1 unaligned roots. An unaligned root is the highest-level in-namespace term without a COB ancestor. To align RXNO with COB, these terms should be moved under COB terms or added to COB.
