...
| ----- | ----- | ----- | ----- |
| All classes (including imports) | 43 | 41 | 95.35% |
| Classes in DUO namespace | 37 | 35 | 94.59% |

DUO has 2 unaligned roots. An unaligned root is the highest-level in-namespace term without a COB ancestor. To align DUO with COB, these terms should be moved under COB terms or added to COB.
