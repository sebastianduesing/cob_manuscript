...
| Classes in ZFA namespace | 3115 | 0 | 0.00% |

ZFA has 1 unaligned roots. An unaligned root is the highest-level in-namespace term without a COB ancestor. To align ZFA with COB, these terms should be moved under COB terms or added to COB.
