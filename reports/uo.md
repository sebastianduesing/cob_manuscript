...
| ----- | ----- | ----- | ----- |
| All classes (including imports) | 573 | 0 | 0.00% |
| Classes in UO namespace | 573 | 0 | 0.00% |

UO has 2 unaligned roots. An unaligned root is the highest-level in-namespace term without a COB ancestor. To align UO with COB, these terms should be moved under COB terms or added to COB.
