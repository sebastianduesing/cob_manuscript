...
| ----- | ----- | ----- | ----- |
| All classes (including imports) | 44 | 0 | 0.00% |
| Classes in CIO namespace | 44 | 0 | 0.00% |

CIO has 2 unaligned roots. An unaligned root is the highest-level in-namespace term without a COB ancestor. To align CIO with COB, these terms should be moved under COB terms or added to COB.
