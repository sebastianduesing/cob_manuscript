...
| ----- | ----- | ----- | ----- |
| All classes (including imports) | 1963 | 1897 | 96.64% |
| Classes in ADO namespace | 53 | 48 | 90.57% |

ADO has 5 unaligned roots. An unaligned root is the highest-level in-namespace term without a COB ancestor. To align ADO with COB, these terms should be moved under COB terms or added to COB.
...
| http://purl.obolibrary.org/obo/ADO_0000024 | early sign | No | 0 |
| http://purl.obolibrary.org/obo/ADO_0000080 | Everyday Cognition questionnaire | No | 0 |
