...
| ----- | ----- | ----- | ----- |
| All classes (including imports) | 2514 | 0 | 0.00% |
| Classes in HAO namespace | 2513 | 0 | 0.00% |

HAO has 37 unaligned roots. An unaligned root is the highest-level in-namespace term without a COB ancestor. To align HAO with COB, these terms should be moved under COB terms or added to COB.
...
| http://purl.obolibrary.org/obo/HAO_0001590 | malar carina | No | 0 |
...
| http://purl.obolibrary.org/obo/HAO_0002545 | internal protrusion | No | 0 |
