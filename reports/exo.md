...
| ----- | ----- | ----- | ----- |
| All classes (including imports) | 167 | 11 | 6.59% |
| Classes in EXO namespace | 166 | 10 | 6.02% |

EXO has 24 unaligned roots. An unaligned root is the highest-level in-namespace term without a COB ancestor. To align EXO with COB, these terms should be moved under COB terms or added to COB.
