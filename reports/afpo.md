...
| ----- | ----- | ----- | ----- |
| All classes (including imports) | 473 | 80 | 16.91% |
| Classes in AFPO namespace | 391 | 0 | 0.00% |

AFPO has 5 unaligned roots. An unaligned root is the highest-level in-namespace term without a COB ancestor. To align AFPO with COB, these terms should be moved under COB terms or added to COB.
