...
| ----- | ----- | ----- | ----- |
| All classes (including imports) | 57 | 34 | 59.65% |
| Classes in RO namespace | 4 | 1 | 25.00% |

RO has 1 unaligned roots. An unaligned root is the highest-level in-namespace term without a COB ancestor. To align RO with COB, these terms should be moved under COB terms or added to COB.
